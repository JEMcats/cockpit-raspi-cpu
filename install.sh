...
echo " Installing raspi-cpu..."

step "1/6" "Removing any previous installation..."
sudo rm -rf /usr/share/cockpit/raspi-cpu || die "Failed to remove old files"
...
sudo cp -r raspi-cpu /usr/share/cockpit || die "Failed to copy files"

step "5/6" "Fixing permissions..."
sudo chmod -R a+r /usr/share/cockpit/raspi-cpu || die "Failed to chmod read"
sudo chmod +x /usr/share/cockpit/raspi-cpu/cpuinfo || die "Failed to chmod cpuinfo exec"
